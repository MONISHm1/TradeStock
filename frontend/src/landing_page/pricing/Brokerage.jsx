    ...
    <div className="container mt-5">
      ...
      <div className="row mt-5">
        <div className="col-6">
          ...
          <p className='price-low-para'>When trading at TradeStock, STT/CTT can be a lot more than the brokerage we charge. Important to keep a tab.</p> 
          ...
          <p className='price-low-para'>Additional charges of ₹50 per order for orders placed through a dealer at TradeStock including auto square off orders.</p>
        ...
        <div className="col-6 ml-5">
          ...
          <p className='price-low-para'>₹15.34 per scrip (₹3.5 CDSL fee + ₹9.5 TradeStock fee + ₹2.34 GST) is charged on the trading account ledger when stocks are sold, irrespective of quantity.</p>
