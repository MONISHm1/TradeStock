    ...
    <div className="container">
      ...
      <div className="row p-5 mt-5 border-top">
        <div className="col-6 p-5">
          <p className='about-para'>We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company TradeStock, a combination of Zero and "Rodha", the Sanskrit word for barrier.</p>
